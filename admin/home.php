  ...
  <div class="container mt-3">
    ...
    <div class="row">
      ...
      if (isset($_GET['albumid'])) {
        ...
        $query = mysqli_query($koneksi, "SELECT * FROM foto1 WHERE userid='$userid' AND albumid='$albumid'");
          ...
          <div class="col-md-3 mt-2">
            <div class="card">
              ...
              <div class="card-footer text-center">
                ...
                ?>
               <a href="suka"><i class="fa-regular fa-heart"></i></a>
            </div>
          </div>
          </div>
            ...
            <div class="col-md-3 mt-2">
              <div class="card">
                ...
                <div class="card-footer text-center">
                  ...
                  echo mysqli_num_rows($like) . ' suka';
                  ?>
                  <a href="../config/proses_komentar.php" type="button" data-bs-toggle="modal" data-bs-target="#Komentar<?php echo $data['fotoid'] ?>"><i class="fa-regular fa-comment"></i></a> 
                  <?php 
      ...
      <footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
        <p>&copy; UKK RPL 2024 | veber hizkia.m </p>
      </footer>
